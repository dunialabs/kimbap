...
services:
  ...
  kimbap-console:
    ...
    environment:
      ...
      KIMBAP_CORE_URL: ${KIMBAP_CORE_URL:-http://kimbap:3002}
      PROXY_ADMIN_URL: ${PROXY_ADMIN_URL:-http://kimbap:3002/admin}
...
# Same machine: http://localhost:3002 or http://kimbap:3002
# Different server: http://192.168.1.100:3002 or https://core.example.com
KIMBAP_CORE_URL=http://kimbap:3002
PROXY_ADMIN_URL=http://kimbap:3002/admin
