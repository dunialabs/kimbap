      ...
      <main className="flex w-full flex-1 flex-col rounded-xl border border-border/60 bg-card shadow-sm">
        <div className="p-4">
          <Link
            ...
            aria-label="Go to the sign-in screen"
          >
            <Image src="/new_logo.svg" alt="Kimbap Console" width={239} height={34} className="block h-auto max-w-full dark:hidden" priority />
            <Image src="/darklogo.svg" alt="Kimbap Console" width={239} height={34} className="hidden h-auto max-w-full dark:block" priority />
          </Link>
        </div>
