...
import { addIpWhitelist } from '@/lib/proxy-api';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await addIpWhitelist(body.ips, user.userid);
