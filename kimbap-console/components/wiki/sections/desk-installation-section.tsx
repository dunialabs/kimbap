import { AlertCircle, CheckCircle, Monitor, Terminal, Download, Shield, PlayCircle, ChevronRight, Lock, Clock, Key, Settings, RefreshCw } from "lucide-react"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Alert, AlertDescription } from "@/components/ui/alert"
import { Badge } from "@/components/ui/badge"
import { Button } from "@/components/ui/button"

export function DeskInstallationSection() {
  return (
    <div className="space-y-8 lg:space-y-12">
      ...
      <div className="text-center">
        ...
        <h1 className="text-2xl lg:text-3xl font-bold mb-2 text-slate-900 dark:text-slate-100">Installing MCP Desk</h1>
